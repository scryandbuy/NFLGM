...
CATALOG = {
 'ARI': dict(coach='Mike LaFleur', gm='Monti Ossenfort', prestige=22, tree='McVay/Shanahan',
 ...
 'BAL': dict(coach='Jesse Minter', gm='Eric DeCosta', prestige=30, tree='Macdonald/Harbaugh defence',
 ...
 'CAR': dict(coach='Dave Canales', gm='Dan Morgan', prestige=32, tree='Shanahan/Carroll offence, Fangio defence (Evero)',
 ...
 'CHI': dict(coach='Ben Johnson', gm='Ryan Poles', prestige=58, tree='Detroit offence / Dennis Allen defence',
 ...
 'CIN': dict(coach='Zac Taylor', gm='Duke Tobin', prestige=52, tree='McVay offence',
 ...
 'GB': dict(coach='Matt LaFleur', gm='Brian Gutekunst', prestige=68, tree='Shanahan wide zone / Gannon two-high',
 ...
 'HOU': dict(coach='DeMeco Ryans', gm='Nick Caserio', prestige=58, tree='Shanahan-tree offence (Caley) / Ryans one-gap defence',
 ...
 'LV': dict(coach='Klint Kubiak', gm='John Spytek', prestige=26, tree='Shanahan/Kubiak wide zone',
 ...
 'LAC': dict(coach='Jim Harbaugh', gm='Joe Hortiz', prestige=82, tree='Harbaugh power / McDaniel motion / Minter two-high (O\'Leary)',
 ...
 'LA': dict(coach='Sean McVay', gm='Les Snead', prestige=90, tree='McVay',
 ...
 'PIT': dict(coach='Mike McCarthy', gm='Omar Khan', prestige=80, tree='West Coast / Patrick Graham defence',
 ...
 'SF': dict(coach='Kyle Shanahan', gm='John Lynch', prestige=84, tree='Shanahan',
 ...
 'SEA': dict(coach='Mike Macdonald', gm='John Schneider', prestige=72, tree='Macdonald defence / Shanahan offence (Fleury)',
 ...
 'TB': dict(coach='Todd Bowles', gm='Jason Licht', prestige=50, tree='Bowles pressure',
 ...
 'TEN': dict(coach='Robert Saleh', gm='Mike Borgonzi', prestige=34, tree='Saleh one-gap / Daboll spread',
 ...
 'WAS': dict(coach='Dan Quinn', gm='Adam Peters', prestige=46, tree='Quinn multiple / Kingsbury-tree spread (Blough)',
