...
MODULES = ['staff_traits', 'club_notes', 'adjust', 'advanced_stats', 'almanac', 'awards', 'cap_engine', 'coaching_pool', 'contract_structure', 'contracts', 'coverage', 'coverage_call', 'cutdown', 'decisions',
