...
# Schedule generation is not on any runtime path - the game ships the real
# 2026 schedule - and the body reads source data that is not part of the
# runtime. Run by hand only.
